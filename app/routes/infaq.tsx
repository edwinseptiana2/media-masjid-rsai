      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid">
          ...
          <blockquote className="mt-6 border-l-2 pl-6  font-normal text-lg text-justify">
            Telah memberitakan kepada kami Isma'il bin Mas'ud dia berkata; Telah
            menceritakan kepada kami Khalid dia berkata; Telah menceritakan
            kepada kami Syu'bah bahwa 'Amru bin Murrah Telah menceritakan kepada
            mereka dari Khaitsamah dari 'Adi bin Hatim dia berkata; Rasulullah ﷺ
            ...
            Rasulullah shallallahu 'alaihi wasallam berlindung dari api neraka
            sebanyak tiga kali, lalu beliau bersabda :
